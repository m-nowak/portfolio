...
const NetflixClone = () => {
  return (
    <div className=" w-full bg-white sm:py-40">
      <div className="max-w-7xl mx-auto flex items-center justify-center overflow-hidden">
        ...
        <div className="px-4 py-2 sm:py-4 flex flex-col w-[100%] md:w-[80%] lg:w-[50%] mx-auto">
          <motion.div
            className="flex flex-col h-full w-full justify-center items-right"
            variants={slideIn("right", "spring", 0.2, 1)}
          >
            <h2 className="mt-6 text-lg sm:text-xl font-medium text-gray-900">
              NETFLIX CLONE
            </h2>
          </motion.div>
          ...
          >
            Web application where user can read movie&apos;s description, watch
            trailer and make own movie list.
          </motion.div>
          <motion.div
          ...
          >
            <a
              href="https://netflix-clone-ten-amber.vercel.app/auth"
            ...
            <a
              href="https://github.com/m-nowak/netflix-clone"
              className="underline hover:no-underline"
              target="blank"
            >
              Code
...
export default SectionWrapper(NetflixClone, "netflix-clone");
